            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-secondary mb-2" href="?mod=page&act=home"><i class="fa fa-angle-right mr-2"></i>Trang chủ</a>

                        <a class="text-secondary mb-2" href="?mod=cart&act=show"><i class="fa fa-angle-right mr-2"></i>Giỏ hàng</a>
                        <a class="text-secondary mb-2" href="?mod=cart&act=checkout"><i class="fa fa-angle-right mr-2"></i>Thanh toán</a>
