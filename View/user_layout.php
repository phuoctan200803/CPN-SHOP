    ...
    <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
        <div class="col-lg-4">
            <a href="index.php" class="text-decoration-none">
                ...
                <img src="img/product/logo2.png" alt="logo" class="w-25
                ">
            </a>
        </div>
...
<!-- Navbar Start -->
<div class="container-fluid mb-30 bg-main">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-9">
            <nav class="navbar navbar-expand-lg navbar-dark py-3 py-lg-0 px-0 bg-main">
...
<!-- Footer Start -->
<div class="container-fluid text-secondary mt-5 pt-5 bg-dark">
