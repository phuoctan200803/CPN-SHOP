                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 top_order_title">
                        <span class="note order_date"><i>Ngày tạo — 18/11/2023</i>
                            <a style=" float: right; " href="/account"><i class="fa fa-arrow-left"
                                    aria-hidden="true"></i>&nbsp;Quay lại trang tài khoản</a>
                        </span>
                        ...
                        <table class="table  totalorders">
                            <tfoot>
                                ...
                                <tr class="order_summary note" style="color:red;">
                                    ...
                                    <td class="total money right">Giao hàng tận nơi <strong
                                            style="color:#f02b2b">200,000₫</strong>
                                    </td>
                                </tr>

                                <tr class="order_summary order_total">
                                    <td class="fix-width-200">Tổng tiền:</td>
                                    <td class="right"><strong><?= number_format($total + 200000) ?> đ</strong></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
