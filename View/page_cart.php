                ...
                <table class="table table-light table-borderless table-hover text-center mb-0 bg-top">
                    ...
                    <tbody class="align-middle">
                        <?php
                            ...
                            ?>
                        <tr>
                            <td class="align-middle" style="display: flex;justify-content: space-between;"><img
                                    src="img/product/<?= $item['anhsp'] ?>" alt=""
                                    style="width: 50px;"><span><?= $item['tensp'] ?></span></td>
                            <td class="align-middle"><?= number_format($item['giakhuyenmai']) ?> đ</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <input type="number"
                                        class="form-control form-control-sm bg-secondary border-0 text-center"
                                        name="qty[<?php echo $item['masp']; ?>]" value="<?= $item['qty'] ?>" min="1"
                                        max="10" />
                                </div>
                            </td>
                            <td class="align-middle"><?= number_format($item['sub_total']) ?> đ</td>
                            <td class="align-middle"><a href="?mod=cart&act=delete&id=<?php echo $item['masp']; ?>"><i
                                        class="fa fa-times p-2 btn-danger"></i></a></td>
                                ...
                                <div class="clearfix">
                                    <div class="fl-right">
                                        <input type="submit" id="update-cart" name="btn_update_cart"
                                            value="Cập nhật giỏ hàng" class="btn border  border-dark">
                                        <a href="?mod=cart&act=delete" title="" id="delete-cart"
                                            class="btn border  border-dark">Xóa giỏ hàng</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
