                                ...
                                <table class="sa-table">
                                    <tbody>
                                        <tr>
                                            <td class="min-w-20x">
                                                <div class="d-flex align-items-center"><img
                                                        src="images/products/product-2-40x40.jpg" class="me-4"
                                                        width="40" height="40" alt="" /><a href="app-product.html"
                                                        class="text-reset">Brandix
                                        ...
                                        <tr>
                                            <td class="min-w-20x">
                                                <div class="d-flex align-items-center"><img
                                                        src="images/products/product-7-40x40.jpg" class="me-4"
                                                        width="40" height="40" alt="" /><a href="app-product.html"
                                                        class="text-reset">Glossy
                                                        Gray 19&quot; Aluminium Wheel AR-19</a></div>
                                            </td>
                                            <td class="text-end">
                                                <div class="sa-price"><span class="sa-price__symbol">$</span><span
                                        ...
                                        <tr>
                                            <td class="min-w-20x">
                                                <div class="d-flex align-items-center"><img
                                                        src="images/products/product-16-40x40.jpg" class="me-4"
                                                        width="40" height="40" alt="" /><a href="app-product.html"
                                                        class="text-reset">Twin
                                    ...
                                    <tbody class="sa-table__group">
                                        ...
                                        <tr>
                                            <td colSpan="3">Shipping<div class="text-muted fs-exact-13">via
                                                    FedEx International</div>
                                            </td>
                                            <td class="text-end">
                                                <div class="sa-price"><span class="sa-price__symbol">$</span><span
                        ...
                        <div class="card">
                            ...
                            <div class="card-body d-flex align-items-center pt-4">
                                <div class="sa-symbol sa-symbol--shape--circle sa-symbol--size--lg"><img
                                        src="images/customers/customer-1-40x40.jpg" width="40" height="40" alt="" />
                                </div>
                                <div class="ms-3 ps-2">
