                            ...
                            <div class="card">
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="form-product/name" name="tensp" />
                                    </div>
                                    <div class="mb-4">
                                        <label for="form-product/description" class="form-label">Description</label>
                                        <textarea id="form-product/description" class=" form-control" rows="8" name="motachitiet"></textarea>
                                    </div>
                                    <div>
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="row g-4">
                                        <div class="col">
                                            ...
                                            <input type="number" class="form-control" id="form-product/price" name="giakhuyenmai" />
                                        </div>
                                        <div class="col">
                                            <label for="form-product/old-price" class="form-label">Old
                                                price</label>
                                            <input type="number" class="form-control" id="form-product/old-price" name="gia" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div>
                                        <label for="form-product/quantity" class="form-label">Stock
                                            quantity</label>
                                        <input type="number" class="form-control" id="form-product/quantity" name="soluong" />
                                    </div>
                                </div>
                            </div>
                        </div>
